  ...
  return (
    <div className="rot space-y-5">
      ...
      <HowToRead>
        ...
        <p><b>Momentum &amp; Acceleration.</b> Burst, RS 0–2w: the two-week strength, the same arithmetic as the Terrain's level axis. Turn, Acceleration: this week's excess minus the prior three weeks' excess per week (÷{PRIOR_WEEKS}). Persistence, Quarter: the quarter's excess. Dots grow with the value; the top five and bottom two are named. Click any dot or name to put it on the Flux line; Escape clears.</p>
