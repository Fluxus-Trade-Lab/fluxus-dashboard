    ...
    <div className={`rounded-lg border p-3.5 bg-[var(--color-bg)] ${win ? 'border-[color-mix(in_srgb,var(--color-profit)_40%,transparent)]' : 'border-[color-mix(in_srgb,var(--color-loss)_40%,transparent)]'}`}>
      <div className="flex items-baseline justify-between mb-0.5">
        <div className="flex items-baseline gap-2">
          ...
          <span className="text-[11px] uppercase px-1.5 py-0.5 rounded bg-[var(--color-surface)] text-[var(--color-text-muted)]">{t.direction}</span>
        </div>
      ...
      <div className={`text-[13px] font-medium mb-2 ${win ? 'text-[var(--color-profit)]' : 'text-[var(--color-loss)]'}`}>{cls.type}</div>
  ...
  return (
    <div className="bg-[var(--color-bg)] rounded-3xl p-4 mb-4">
      <div className="flex items-baseline gap-2 mb-1">
        ...
        <span className="font-semibold text-[13px]">Trade case studies — 4 biggest winners & 4 biggest losers</span>
      </div>
