...
export default function TickerStats({ universe }) {
  ...
  const cells = [
    ...
    ['Avg Vol (20D)', u.avg_volume ? `${(u.avg_volume / 1e6).toFixed(1)}M` : '—'],
    ...
    ['52W High%', u.high_52w_dist != null ? `${(u.high_52w_dist * 100).toFixed(1)}%` : '—'],
    ['Dist 20SMA%', u.sma20_dist != null ? `${(u.sma20_dist * 100).toFixed(1)}%` : '—'],
