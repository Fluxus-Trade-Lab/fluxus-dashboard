...
| **在群但台账里没有这个人** | **2** | `titan_675`（无角色，邀请链接，2026-05-07）· **`geling`（持 Early Birds Legacy 付费角色，邀请链接，2025-11-16）** | ⚠️ **`geling` 是最需要 Andy 确认的一个：持早鸟付费角色，但任何付款流水、任何会员记录里都没有他。**要么是漏记的付费会员（则会员数与收入口径都要改），要么是手动授予的角色。 |
