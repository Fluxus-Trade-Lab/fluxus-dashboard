...
> ⚠️ **S1 更正（Nighty Zac 2026-09-19）**：S1 引的「今天漏 47/55」建在 06-26 之后的全市场宇宙上——那 47 只里 **45 只 `<$1B`**（44 只 `<$500M`）；在 06-25 的 ≥$1B 人口下漏掉的是 **2 只**。
> 筛子单已于 2026-09-18 加回 ≥$1B 闸（`ed106472`）。**S1 在新人口上重量之前不该执行**；影子清单若开，也只在 ≥$1B 子集上比。出处：[`breadth_universe_break_2026-09-18/README.md`](../breadth_universe_break_2026-09-18/README.md) §十一「复核多查出来的」第 6 条。
