...
> ⚠️ **半字母表标注（Nighty Zac 2026-09-17）**：本复盘 358 行的 as_of 全部在 `delayed_ep_log` 的继承脏区（08-13..08-27），M–Z 只占 0.6%。结论「判不了」不受影响，但文中所有数字（p=0.1484、胜率差 9pt）来自半个宇宙。详见 [重报](../half_alphabet_reach_2026-09-17/README.md)。
