...
**这个槽位该放什么(推论,做的时候再验):** Lupi 那三件 —— Bruises(一个孩子的病程)、
My 2020(她自己的一年)、Hennessy —— 共同点是**长时间、个人、手工累积**。

> **它们暖,是因为里面有人,不是因为线是弯的。**

所以:**「这一周市场怎么样」不需要手** —— 条形已经完全说清,再画一张抽象图是重复。
**需要手的是「这一周我们在里面做了什么、错过了什么」** —— 进的和没进的、看见但放过的、
拿到的对照当时能拿到的(`capture_pct` 那条线)。那是一份累积的个人记录,
而这正是这个媒介真正擅长的形态。

这也解释了为什么槽位在信里而不在仪表盘上:**仪表盘上没有「人」,只有市场。**
