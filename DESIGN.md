...
### 实测(`explorations/2026-08-08/palette.html` 可复跑)
...
> ⚠️ **待迁移**:`Fluxus_Poster_System.md` 与 `scripts/make_poster.py` 仍写着
> Inter / JetBrains Mono / `#fafaf9`。框和三个被毙掉的版本继续有效,**只有字体和纸色要换**。
...
- 演员记号(First Penguin / Herd / Algo Monkeys / Market God)还没在真页面上试过
- 海报脚本 `scripts/make_poster.py` 的字体迁移
- 信 / X 的模板尚未做成可复用件(映射表见 `Fluxus_Voice_To_Template.md`)
- 深色模式:v2 编码只在浅色纸上完整验证过,深色需要重跑一次灰度测试
