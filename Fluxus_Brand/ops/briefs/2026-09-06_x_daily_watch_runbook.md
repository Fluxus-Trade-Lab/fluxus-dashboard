...
5. **判断步(你读 jsonl 后写)**:给前 5 ticker 每条相关帖标 stance,词表**只有六个**:`long / short / watching / exited / recap / mention`;回填 mentions.csv。
   ...
   **七节,每节一屏内:**
   ...
   > ⚠️ **09-13 更正(跑手 09-08 报「任务书说七节、手册写六节」):09-07 起是七节。** 第 5 节插入「墙后 vs 墙外(@jfsrev 专节)」,下面原来的 5/6 顺延为 6/7;「圈外主题起量」作为 3a 并入第 3 节。
   > **节目清单以主班任务书 `steve-x-daily-watch` 为准** —— 它每班都在跑、跟着实测改;本手册下方的六节是 09-06 的初版,留作设计理由,不再是节目单。
