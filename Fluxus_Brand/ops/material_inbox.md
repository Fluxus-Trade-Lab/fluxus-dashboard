...
- [2026-09-23 · UI Claire] Market State 广度段换成「指数在上、指标在下」两窗图，历史超卖段打灰带，旁边一张表：过去 12 个月 14 次新高新低超卖之后 20 个交易日，标普 12 次为正——牛市样本，读的时候要记住。σ 尺子照 Alex（PrimeTrading）的读法：−1σ 警戒、−2σ 深超卖。可讲：「像不像上一次」要靠尺子和表，不靠肉眼。出处 `86d84154`。
