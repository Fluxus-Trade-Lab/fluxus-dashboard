...
// ============================================================================
// Follow Traders — Delivery Script
// ============================================================================
...
//
// The script reads delivery config from ~/.follow-traders/config.json
// and API keys from ~/.follow-traders/.env
//
// Delivery methods:
...
async function sendEmail(text, apiKey, toEmail) {
  const res = await fetch('https://api.resend.com/emails', {
    ...
    body: JSON.stringify({
      from: 'Trader Digest <digest@resend.dev>',
      to: [toEmail],
      subject: `Trader Digest — ${new Date().toLocaleDateString('en-US', {
