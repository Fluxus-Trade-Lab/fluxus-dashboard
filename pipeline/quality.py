...
#
# f_score -> growth_score (2026-09-18, commit 421b2777): renamed to stop the
# Piotroski-name collision, same shape as the two renames above -- same-day
# same-cause. Missed this list the day of the rename, so the first run after
# it read f_score as a dead feed (100% missing against a healthy history) and
# refused to publish: workflow_dispatch run 35399820824, 2026-09-18 22:03Z.
